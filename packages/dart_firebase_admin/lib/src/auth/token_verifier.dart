  ...
  factory DecodedIdToken.fromMap(Map<String, Object?> map) {
    return DecodedIdToken(
      ...
      firebase: TokenProvider(
        identities: Map.from((map['firebase']! as Map)['identities']! as Map),
        signInProvider: (map['firebase']! as Map)['sign_in_provider']! as String,
        signInSecondFactor: (map['firebase']! as Map)['sign_in_second_factor'] as String?,
        secondFactorIdentifier: (map['firebase']! as Map)['second_factor_identifier'] as String?,
        tenant: (map['firebase']! as Map)['tenant'] as String?,
      ),
      iat: map['iat']! as int,
